...
v_query = 'SELECT * fROM XENMSEVOLUZIONETASK  WHERE rownum<100000'
#v_query += '
v_arraysize_s = 100
for v_loopindex in range(1,10,1):
    con = cx_Oracle.connect('TEST70ENELMERCATO/test70enelmercato@//test-oracle-12/test121p1.overit.it')
    cur = con.cursor()
