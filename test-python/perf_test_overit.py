...
for outer_loop_i in range(1,10):
    con = cx_Oracle.connect('sviluppo60/sviluppo60@//svil-oracle-12/svil121p1.overit.it')
    con_selsing = cx_Oracle.connect('sviluppo60/sviluppo60@//svil-oracle-12/svil121p1.overit.it')
    con_ins = cx_Oracle.connect('sviluppo60/sviluppo60@//svil-oracle-12/svil121p1.overit.it')
    cur = con.cursor()
