...
for outer_loop_i in range(1,10):
    con = cx_Oracle.connect('sviluppo60/factorydevu03pwd#@//rds-dublin.svil.internal-test.aws.overit.it/FACTORY')
    con_selsing = cx_Oracle.connect('sviluppo60/factorydevu03pwd#@//rds-dublin.svil.internal-test.aws.overit.it/FACTORY')
    con_ins = cx_Oracle.connect('sviluppo60/factorydevu03pwd#@//rds-dublin.svil.internal-test.aws.overit.it/FACTORY')
    cur = con.cursor()
