g_plsql_dpimp = """DECLARE
        ...
        p_table_name varchar2(30) := '{.p_table_name}';
        p_table_exists_action varchar2(30) := '{.p_table_exists_action}';
    ...
    v_table_exists_action varchar2(30);
    ...
    v_table_exists_action := upper(p_table_exists_action);
    ...
    --TABLE_NAME--DBMS_DATAPUMP.METADATA_FILTER(handle=>v_handle, name=>'NAME_EXPR', value=>'='''||v_table_name||'''', object_path=>NULL);
    dbms_datapump.set_PARAMETER(handle=>v_handle, name=>'TABLE_EXISTS_ACTION',value=>v_table_exists_action);
    ...
    dbms_datapump.add_file(handle=>v_handle, filename=>v_dumpfilename,directory=>v_directory,filetype=>DBMS_DATAPUMP.KU$_FILE_TYPE_DUMP_FILE, reusefile=>0);
