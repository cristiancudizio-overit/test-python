        ...
        while (1==1):
            ...
            for r in res:
                ...
                if (str(r[2]) != 'NONE'):
                    ...
                    myTeamsMessage.title("ALERT su "+str(r[4]))
                    myTeamsMessage.text(str(r[1]))
                    # Create Section 1
                    Section1 = pymsteams.cardsection()
                    Section1.text("Dettagli")
                    Section1.addFact(str(r[4]), str(r[1])+' '+str(r[2])+' '+str(r[5])+' '+str(r[6])+' '+str(r[7]))
